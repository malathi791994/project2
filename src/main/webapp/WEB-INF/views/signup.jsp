...
<h4>Signup! </h4>
 ...
 <label for="password">confirmpassword
<input type="password" name="confirmpassword" id="password" required/>      </label>
...
<div class="container">
  <div class="login">
    ...
    <form method="post" action="./welcome">
      ...
      <p><input type="text" name="emailid" value="" placeholder=" emailid" required></p>
      <p><input type="password" name="password" value="" placeholder="Password" required></p>
        <p><input type="password" name="confirmpassword" value="" placeholder="confirmPassword" required></p>
      <p style="color:red;">${error}</p>
    <!--   <p class="remember_me">
        <label>
         <label>
