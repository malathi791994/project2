...
.login-register{
	...
	<body>
		...
		<!-- <div class="container"> -->
		 ...
		 <form:form action="./forum1" commandName="flo" method="post" class="form-horizontal">				
						<!-- <div 
...
<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<form:input path="creationDate" type="text" class="form-control" name="name" id="name"  placeholder="Enter your Name"/>
								</div>
			 --%>
...
<label for="email" class="cols-sm-2 control-label">Query</label>
...
hidden="true"></i></span>
									<form:input type="text" path="query" class="form-control" name="email" id="email"  
...
for="username" class="cols-sm-2 control-label">Queryinventor</label>
							<div class="cols-sm-10">
...
class="fa fa-users fa" aria-hidden="true"></i></span>
									<form:textarea type="text" path="queryinventor" class="form-control" name="username" id="username"  placeholder="Enter your author"></form:textarea><div class="form-group">
...
<div class="form-group">
							<label for="text" class="cols-sm-2 control-label">Ideas</label>
					...
					<div class="cols-sm-10">
						...
						<form:input type="text" path="ideas" class="form-control" name="confirm" id="confirm"  placeholder="Enter yout ideas"/>
...
<p class="submit"><input type="submit" value="POST"></p>
	...
	<a href="forumlist">to list forumdetails</a>
