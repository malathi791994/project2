...
<h1>comments</h1>
								<%-- <form >
									...
									<textarea placeholder="comment" class="searchButton" ></textarea>
									<input placeholder="user name" class="searchButton" />
									
									<input id="addItem" type="submit" value="comment!" />
								</form>
								<div >
								...
								<a href="deleteblog?id=${b.id}">DELETE</a>
								<a href="view?id=${b.id}">CONFIRM</a>
							</div>
						</div>
					</div>
		</center>		<!-- </div>
